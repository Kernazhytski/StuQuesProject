    ...
    <div className={classes.container}>
      {
        ...
        <form className={classes.loginCard}>
          ...
          <button className={classes.but}>Авторизироваться</button>
        </form>
        :
        <form className={classes.loginCard}>
          ...
          <p className={classes.txt}>Пароль:</p>
          <input className={classes.inp} placeholder='Введите пароль'/>
          <p className={classes.link}>Есть аккаунт?<Link to={LOG_ROUTE}> Авторизироваться</Link></p>
          <button className={classes.but}>Зарегистрироваться</button>
        </form>
      }
    </div>
  )
